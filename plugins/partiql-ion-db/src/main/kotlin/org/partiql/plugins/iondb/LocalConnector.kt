...
import org.partiql.plugins.iondb.LocalConnector.Companion.ROOT_KEY
...
class LocalConnector(private val catalogName: String, private val config: StructElement) : Connector {
    ...
    companion object {
        const val CONNECTOR_NAME = "ion-db"
        const val ROOT_KEY = "ion-db-root"
    }

    private val default: Path = Paths.get(System.getProperty("user.home"))
