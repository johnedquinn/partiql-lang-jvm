...
internal abstract class ArithmeticDiadicOperator : Function {
    ...
    override fun getInstance(args: Array<PType>): Function.Instance? {
        ...
        val lhs = args[0].let {
            when (it.kind) {
                PType.Kind.DECIMAL_ARBITRARY -> PType.decimal(38, 0) // TODO: Remove decimal arbitrary
                else -> it
            }
        }
        val rhs = args[1].let {
    ...
    init {
        ...
        fillTable(PType.Kind.DECIMAL_ARBITRARY) { lhs, rhs -> getDecimalInstance(lhs, rhs) } // TODO: Remove this
